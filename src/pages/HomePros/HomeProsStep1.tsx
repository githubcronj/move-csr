...
class HomeProsStep1 extends React.Component<initialProps, initialState> {
  state: initialState = {
    isDataArrived: true,
    hintContent: "",
    listContent: [
      ...
      <div className="ConciergeFlowPage">
        ...
        <div className="component-div">
          <div className="componetContent">
            <div className="homePros1-main">
              <div className="homePros1-heading">
                <div className="homePros1">Home Pros </div>
                <div>
                    ...
                    {this.state.currentObjectionStep == 2 ? (
                      <div className="objection-step-2">
                        ...
                        {this.state.listContentObjection.map((item: any) => {
                          return (
                            <div className="point-content-wrapper-homePros1">
                              <div className="points-div-homePros1">
                                <div className="outer-point-homePros1">
                                  <div className="inner-point-homePros1"></div>
                                </div>
                                <div className="vertical-line-homePros1"></div>
                              </div>

                              <div className="point-content-homePros1">
                                {item}
                              </div>
                            </div>
                          );
                        ...
                        <div className="mindset-div-bottom">
                          {this.state.objectionList1.map((item: any) => {
                            if (item.selected == true) {
                              return (
                                <div className="point-content-wrapper2-homePros1">
                                  <div className="points-div-homePros1">
                                    <div className="outer-point-homePros1">
                                      <div className="inner-point-homePros1"></div>
                                    </div>
              ...
              {this.state.listContent.map((item: any) => {
                return (
                  <div className="point-content-wrapper-homePros1">
                    ...
                    <div className="point-content-homePros1">{item}</div>
                  </div>
                );
              })}
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(HomeProsStep1);
