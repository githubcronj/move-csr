...
class EnergyStep3 extends React.Component<initialProps, initialState> {
  state: initialState = {
    isDataArrived: true,
    hintContent: "",
    listContent: [],
  ...
  nextHandler = () => {
    this.props.history.push("/dashboard/concierge/workflow/energystep4");
  };
            ...
            <div className="energy1-main">
              ...
              <div className="point-content-wrapper-insurance1">
                ...
                <div className="point-content-insurance1">
                  <div className="scheduleText">Personal Information</div>
                  <div className="formDiv">
                    ...
                    <div className="InputsDiv">
                      <div className="inputDiv">
                        <div className="title" style={{ color: "#333333" }}>
                          Please indicate the date you would like new service to
                          start
                        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(EnergyStep3);
