...
import "./securitySpecialistStep2.scss";
...
class SpecialistStep2 extends React.Component<initialProps, initialState> {
  state: initialState = {
    isDataArrived: true,
    hintContent: "",
    // listContent: [
        ...
        <div className="component-div">
          <div className="componetContent">
            <div className="securitySpecialist1-main">
              ...
              <div className="point-content-wrapper-securitySpecialist1">
                ...
                <div className="point-content-securitySpecialist1">
                  Do you have an existing home security system at home?
                  <div className="securityspeButtonDiv">
                    ...
                    <Button
                      ...
                      backgroundColor={
                        this.state.buttonClicked === "No" ? "#408867" : "#fff"
                      }
                      onClick={() => {
              ...
              <div className="point-content-wrapper-securitySpecialist1">
                ...
                <div className="point-content-securitySpecialist1">
                  How do you prefer it to be installed?
                  <div className="securityspeButtonDiv">
                    <div className="securtiyspecButtonContent">
                      <Button
                        className="existinghome"
                        color={"#0C152E"}
                        border={
                          this.state.installedButton === "DIY"
                            ? ""
                            : " 1px solid #408867"
                        }
                        backgroundColor={
                        ...
                        onClick={() => {
                          this.setState({ installedButton: "DIY" });
                        }}
                      >
                        DIY
                      </Button>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        this.setState({
                          installedButton: "Professional installation",
                        });
                      }}
                    >
                      Professional installation
          ...
          <div className="WorkflowButtons">
            <WorkflowButton
              ...
              ButtonOnClick2={() => {
                this.props.history.push(
                  "/dashboard/concierge/workflow/securityspecialiststep3"
                );
              }}
            />
          </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(SpecialistStep2);
