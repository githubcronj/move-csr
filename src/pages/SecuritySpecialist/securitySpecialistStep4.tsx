...
class SpecialistStep4 extends React.Component<initialProps, initialState> {
  state: initialState = {
    isDataArrived: true,
    hintContent: "",
    listContent: [
...
export default connect(mapStateToProps, mapDispatchToProps)(SpecialistStep4);
