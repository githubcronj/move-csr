...
class UtilitiesStep1 extends React.Component<initialProps, initialState> {
  state: initialState = {
    isDataArrived: true,
    hintContent: "",
    listContent: [
      //  <div>The last step in our process will be getting your electricity and natural gas utilities set up.</div>,
      ...
      <div className="ConciergeFlowPage">
        ...
        <div className="component-div">
          <div className="componetContent">
            <div className="utilities1-main">
              <div className="utilities1-heading">
                    ...
                    {this.state.currentObjectionStep == 2 ? (
                      <div className="objection-step-2">
                        ...
                        {this.state.listContentObjection.map((item: any) => {
                          return (
                            <div className="point-content-wrapper-utilities1">
                              <div className="points-div-utilities1">
                                <div className="outer-point-utilities1">
                                  <div className="inner-point-utilities1"></div>
                                </div>
                                <div className="vertical-line-utilities1"></div>
                              </div>

                              <div className="point-content-utilities1">
                                {item}
                              </div>
                            </div>
                          );
                        ...
                        <div className="mindset-div-bottom">
                          {this.state.objectionList1.map((item: any) => {
                            if (item.selected == true) {
                              return (
                                <div className="point-content-wrapper2-utilities1">
                                  <div className="points-div-utilities1">
                                    <div className="outer-point-utilities1">
                                      <div className="inner-point-utilities1"></div>
                                    </div>
                  ...
                  return (
                    <div className="point-content-wrapper-utilities1">
                      ...
                      <div
                        ...
                        className="point-content-utilities1"
                      ></div>
                    </div>
                  );
                })}
...
export default connect(mapStateToProps, mapDispatchToProps)(UtilitiesStep1);
