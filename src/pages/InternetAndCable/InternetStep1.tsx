...
class InternetStep1 extends React.Component<initialProps, initialState> {
  state: initialState = {
    isDataArrived: true,
    hintContent: "",
    listContent: [
      // "Next thing we typically handle is your utilities.  ",
      // "First of which being Internet.  Who do you currently have? ",
      // "What were you looking for at the new place?"
    ],
    closed: false,
                        ...
                        <div className="mindset-div-bottom">
                          {this.state.objectionList1.map((item: any) => {
                            if (item.selected == true) {
                              return (
                                <div className="point-content-wrapper2-internet1">
                                  <div className="points-div-internet1">
                                    <div className="outer-point-internet1">
                                      <div className="inner-point-internet1"></div>
                                    </div>
            ...
            <WorkflowButton
              ...
              ButtonOnClick1={() =>
                this.props.history.push(
                  "/dashboard/concierge/workflow/securitystep3"
                )
              }
              ButtonOnClick2={() => {
                this.props.history.push(
...
export default connect(mapStateToProps, mapDispatchToProps)(InternetStep1);
